...
# Read in data
df = read.csv("C:/Users/Kiat Kai/Desktop/NOTES/FYP/Full Dataset/weekly_weekdays.csv")
...
################################################
## Hieracrchical clustering for 27 dimensions ##
################################################
model.famd = FAMD(df, ncp=27, graph=FALSE)
